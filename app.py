...
def ask_gemini_analyst(financial_data, ticker):
    ...
    try:
        ...
        ฉันมีข้อมูลงบการเงินของหุ้น {ticker} ย้อนหลัง 3 ปี หรือข้อมูลกองทุน ETF
        
        กรุณาวิเคราะห์ข้อมูลต่อไปนี้แบบเจาะลึก:
        {financial_data}
        
        สิ่งที่ต้องการให้ตอบ (เป็นภาษาไทย):
        1. 📊 **สรุปภาพรวม:** (แข็งแกร่ง/ปานกลาง/น่าเป็นห่วง) เพราะอะไร?
        2. 📈 **แนวโน้มการเติบโต:** รายได้/กำไร หรือ ปันผล เป็นอย่างไร?
        3. 🚩 **ความเสี่ยง:** มีสัญญาณอันตรายอะไรไหม?
        4. 🎯 **คำแนะนำ (Verdict):** เหมาะกับการถือยาว DCA หรือไม่?
        
        ตอบสั้นๆ กระชับ เข้าใจง่าย สำหรับนักลงทุนรายย่อย
        """
        
        with st.spinner("🤖 AI กำลังอ่านงบ... (ใช้สมองรุ่น 1.5 Flash)"):
